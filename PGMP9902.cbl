      ...
      *-----------------------------------------------------------------
       ...
       01  WK-AC-PAGINAS               PIC 9(06) VALUE ZEROS.
       ...
       01  WK-SALDO-MEDIO              PIC 9(06)V999 VALUE ZEROS.
      ...
      **** 1 MONTEDATA PROCESSADORA DE DADOS LTDA
       01  WK-RELATO1.
           ...
           05 REL1-PAG                 PIC X(10) VALUE SPACES.
           05 FILLER                   PIC X(05) VALUE SPACES.
           05 FILLER                   PIC X(08) VALUE 'ETPXXX01'.
      ...
      *****8 NUMERO NOME SALDO MEDIO
       01  WK-RELATO8.
           ...
           05 DET-SALDO-CLI            PIC 9(06)V99 VALUE ZEROS.
           05 DET-SALDO-CLI1 REDEFINES   DET-SALDO-CLI  PIC X(08).

      *****3 TOTAIS DE CONTROLE - ETFXXX01 -
       01  WK-RELATO9.
           05 FILLER                   PIC X(10) VALUE SPACES.
           05 FILLER                   PIC X(32) VALUE
           "TOTAIS DE CONTROLE - ETFXXX01 - ".
      ...
      *    LER OS REGISTROS DO ARQUIVO
           ...
           2043-IMPRIMIR-DETALHO SECTION.
               ...
               MOVE WK-SALDO-MEDIO TO DET-SALDO-CLI
           ...
           3000-FINALIZAR SECTION.
               ...
               WRITE REG-REL FROM WK-RELATO9  AFTER 5
